          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-corporate-gray leading-relaxed mb-8">
                Experience the power of transparent, user-centric property management with Blume Space. Discover how Blume Space can transform your real estate operations.
              </p>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-corporate-gray leading-relaxed text-center animate-slide-in-right">
                Blume Space isn’t just another property management platform-it’s a transformative digital experience built for transparency, control, and convenience in the UAE residential real estate sector. Whether you’re a tenant, landlord, real estate developer or a property manager, Blume Space empowers you with tools that simplify operations and elevate trust.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => (
                <Card key={index} className="group hover:shadow-large transition-all duration-300 animate-fade-in border-corporate-border">
